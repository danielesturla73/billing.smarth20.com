...
**Sul tipo di lettura SPEZZATURA (aggiunta 20/09/2026)**
11. Cosa rappresenta esattamente una lettura di tipo SPEZZATURA? Nei dati (Belgioioso) cade a fine mese/trimestre (es. 31/08/2025, 30/04/2026), ha un valore vicino a quello della STIMATA dello stesso giorno ma non uguale (utenza 53635076: STIMATA 557, SPEZZATURA 550) ed è fatturata mesi dopo (18/12/2025 contro il 19/09/2025 della STIMATA), quando arriva la lettura reale successiva. La nostra ipotesi è che sia un taglio di calendario del consumo di un periodo lungo, con valore calcolato e non letto sul contatore. **Oggi il motore la tratta come una stima** (non è in `TIPI_LETTURA_REALE`, non fa da ancora; **decisione di Daniele 20/09/2026**, in attesa della risposta di Neta che verrà chiesta il 21/09/2026). Se risultasse una lettura fisica, va aggiunta a `TIPI_LETTURA_REALE` e va rifatta la verifica su utenze reali prima di cambiare il Metodo B.
